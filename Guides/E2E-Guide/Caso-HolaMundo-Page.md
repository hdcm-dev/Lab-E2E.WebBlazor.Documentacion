...
```bash
PROYECTO=holamundo scripts/pruebas.sh             # una corrida
REPETIR=8 PROYECTO=holamundo scripts/pruebas.sh   # ocho, para buscar intermitencias
```
...
[`evidencia/2026-09-03-testigo-de-hidratacion/`](../../../Lab-E2E.WebBlazor/evidencia/2026-09-03-testigo-de-hidratacion/)—.
